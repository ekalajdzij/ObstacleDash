...
mqtt_conn=MQTTClient(client_id='player2vffb',server='broker.hivemq.com',user="",password="",port=1883)
...
def makeRecivedRequestScreenDesign():
    ...
    display.print('Player 1 sent you a request')
    display.set_color(WHITE,BLACK)
...
def joystickDirections():
    ...
    if(y_value<2000):
        direction=1         # smjer joysticka je gore gore
    elif(y_value>50000):
        direction=2         # smjer joysticka je gore dole
    if(x_value<2000):
